...
let najStudent = studenti => {
  let naj = studenti[0]; // Predpostavka da je ovo najbolji student 
...
let sviNajStudent1 = studenti => {
  ...
  studenti.forEach( student => {    
    if (prosek_najboljeg == prosecnaOcena(student.ocena)) {
      return `${ime_najboljeg} ${prezime_najboljeg}`;
    }
...
console.log(sviNajStudent1(studenti));